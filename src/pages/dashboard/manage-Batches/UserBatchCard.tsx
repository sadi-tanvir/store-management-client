...
import { DeleteIcon, NameIcon, ViewIcon } from '../../../components/shared/icons/icons';
                    ...
                    <div className="flex flex-col sm:border-l col-span-3">
                        ...
                        <div className="flex flex-col w-full relative bottom-0">
                            <div className="grid grid-cols-2 border-t divide-x text-[#0ed3cf]  bg-gray-50 dark:bg-transparent py-3">
                                ...
                                <span onClick={() => navigate('/individual-batch-details/asdf')} className="cursor-pointer uppercase text-xs flex flex-row items-center justify-center font-semibold">
                                    <ViewIcon />
                                    Details
                                </span>
                            </div>
